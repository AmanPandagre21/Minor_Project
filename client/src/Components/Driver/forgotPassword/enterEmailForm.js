...
import { forgot_password_reset } from "../../../Slices/DriverSlices/driverAuthSlice";
import { forgot_password } from "../../../Slices/DriverSlices/driverAuthSlice";
...
const EnterEform = () => {
  ...
  const { status, setMessage } = useSelector((state) => state.driverAuth);
