...
import { logout_agency } from "../../Slices/TravelAgenciesSlices/travelAuthSlice";
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                  <Avatar alt={agency.name} src={agency.avatar.url} />{" "}
                  <h4 style={{ marginLeft: "3px" }}>{agency.name}</h4>
                </IconButton>
              </Tooltip>
              <Menu
                sx={{ mt: "45px" }}
